...
public class postMatchList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    Button btnLive,btnNormal;
    public Bundle arr;
    String data[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_match_list);
        btnLive=findViewById(R.id.btnLive);
        btnNormal=findViewById(R.id.btnNormal);
        arr =getIntent().getExtras();
        data=arr.getStringArray("details");
        mDrawer = findViewById(R.id.pmlb);
        mToggle = new ActionBarDrawerToggle(postMatchList.this, mDrawer, R.string.open, R.string.close);
        mDrawer.addDrawerListener(mToggle);
        NavigationView navigationView = findViewById(R.id.nav_view7);
        navigationView.setNavigationItemSelectedListener(postMatchList.this);
        ...
        btnLive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(postMatchList.this,MainActivity.class);
                String arr[]={data[0],data[1],"live"};
        ...
        btnNormal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(postMatchList.this,MainActivity.class);
                String arr[]={data[0],data[1],"normal"};
                intent.putExtra("details",arr);
                startActivity(intent);
