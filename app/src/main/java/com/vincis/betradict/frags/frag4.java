...
import com.vincis.betradict.SnapHelperByOne;
            ...
            if(arr[2].equals("normal")) {
                if (quest.myans.equals("A")) {
                    ...
                    if (filex.exists()) {
                        ...
                        friendViewHolder.btn1.setAnimation(animation2);
                    ...
                    if (filex2.exists()) {
                        ...
                        friendViewHolder.btn2.clearAnimation();
                    ...
                    if (filex3.exists()) {
                        ...
                        friendViewHolder.btn3.clearAnimation();
                    } else {
                    ...
                    if (filex.exists()) {
                        friendViewHolder.btn1.setImageBitmap(BitmapFactory.decodeFile(filex.getPath()));
                        friendViewHolder.btn1.clearAnimation();
                    } else {
                    ...
                    if (filex2.exists()) {
                        friendViewHolder.btn2.setImageBitmap(BitmapFactory.decodeFile(filex2.getPath()));
                        friendViewHolder.btn2.setAnimation(animation2);
                    ...
                    if (filex3.exists()) {
                        friendViewHolder.btn3.setImageBitmap(BitmapFactory.decodeFile(filex3.getPath()));
                        friendViewHolder.btn3.setAnimation(animation2);
            ...
            friendViewHolder.btn1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    else if (parseInt(friendViewHolder.etAmt.getText().toString())<2)
                    {
                        ...
                        updatequest(Integer.parseInt(friendViewHolder.etAmt.getText().toString()), "A", quest.qid,mDatabase.child("quest").child(arr[0]).child(arr[1]).child(arr[2]).child(quest.qid));
